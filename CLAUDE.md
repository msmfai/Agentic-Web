...
**Current project state**: [[index/repository-map.md|Repository Map]] - High-level snapshot of domains, layers, and patterns in use
**All available tags**: [[index/tag-index.md|Tag Index]] - Complete inventory of every tag with file listings
...
See [[index/repository-map.md|Repository Map]] for the current tag hierarchies in use.
...
1. Check [[index/repository-map.md|Repository Map]] for available domains/layers/patterns
...
See [[obsidian/tag-inheritance.md|Tag Inheritance]] for complete explanation and gotchas.
...
- Different directory: Use root-relative path (e.g., `[​[obsidian/concept.md|Display]]`)
...
- Block marker references (e.g., `[​[file.md#^marker]]`) resolve correctly
...
3. Use wikilinks in docstrings to reference:
   - Related concepts: `[​[obsidian/concept-name.md|Display]]`
   - Design patterns: `[​[obsidian/pattern-name.md|Display]]`
   - Other code: `[​[code/filename.py|Display]]`
...
3. Use wikilinks to create graph relationships:
   ...
   - Link to docs: `[​[obsidian/other-doc.md|Display]]`
...
**Keeping references up-to-date**: Run `uv run update.py` after adding/removing files or changing tags to regenerate [[index/repository-map.md|Repository Map]] and [[index/tag-index.md|Tag Index]].
